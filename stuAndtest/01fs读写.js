...
// 异步创建文件夹,如果路径中包含不存在的父级目录，会自动创建所有缺失的中间目录
// 不会重复创建文件夹
...
// 例如 读取json文件 简单的路径
const aiphotoStr = fs.readFileSync("./aichat.aiphotos.json", "utf-8");
// 转化一下json即可
const aiphoto = JSON.parse(aiphotoStr);
console.log("json数据会被作为js对象/数组被使用");
